...
urlpatterns = [
        ...
        path("archive/modal", views.ModalArchiveView.as_view(), name="modal_archive"), 
        path("archive/<int:archive_id>", views.ArchiveView.as_view(), name="archive"), 
        path("text/markdown/<int:root_section_id>", views.MarkdownTextView.as_view(), name="markdown_text"),
